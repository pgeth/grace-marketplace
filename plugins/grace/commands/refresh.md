...
- Missing from graph → add entry using unique ID-based tag (`<M-xxx NAME="..." TYPE="...">`) with `<fn-name>`, `<type-Name>` annotation tags. See CLAUDE.md "Documentation Artifacts" for full convention.
