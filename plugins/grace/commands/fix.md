Debug an issue using GRACE semantic navigation. Input: $ARGUMENTS (error message, log line, or problem description)
...
- Search for `START_BLOCK_<BLOCK_NAME>` in the codebase — this is the exact location
